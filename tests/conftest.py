...
from app import db
from app.models import User, Address, State, Category, Group, Provider,\
    Review, FriendRequest, GroupRequest, addressTuple, Sector, Picture,\
    Message, Message_User
from app.utilities.geo import AddressError, APIAuthorizationError
...
class FunctionalTest(object):
    ...
    def getRequest(self, client, *args, headers=None, **kwargs):
        ...
        return client.get(
            url_for(self.routeFunction, *args, **kwargs, _external=False),
    ...
    def postRequest(self, client, **kwargs):
        """Return response from password reset request"""
        return client.post(
            url_for(self.routeFunction, **kwargs, _external=False),
...
def test_db(app):
    ...
    # add test users
    u1 = User.create(
        id=1, username="sarahsmith", first_name="Sarah", last_name="Smith",
        email="sarahsmith@yahoo.com", address=a1
    )
    u2 = User.create(
        id=2, username="jjones", first_name="John", last_name="Jones",
    ...
    u3 = User.create(
        id=3, username="yardsmith", first_name="Mark", last_name="Johnson",
    ...
    User.create(
        id=4, username="nukepower4ever", first_name="Hyman",
    ...
    p4 = Provider.create(
        ...
        email="basic@electric.com", is_active=False, categories=[c1],
        address=Address(
            line1="7708 Covey Chase Dr", line2='', city="Charlotte",
...
def baseAddress():
    testCase = {
        "line1": "13 Brook St", "city": "Lakewood", "state": "2",
        "zip": "14750"
    }
    return testCase
...
def newAddressDict():
    testCase = {
        "unknown": False, "line1": "13 Brook St", "line2": '',
...
def baseUserNew():
    testCase = {
        ...
        "address-state": "2", "address-zip": "14750", "address-line2": ''
    }
    return testCase
...
def base_user():
    testCase = {
        ...
        "password": "password", "confirmation": "password",
        "address": {
            "line1": "7708 Covey Chase Dr", "city": "Charlotte", "state": "1",
            "zip": "28210"
        }
    }
    return testCase
...
def baseUser():
    testCase = {
        "first_name": "John", "last_name": "Jones",
        "email": "jjones@yahoo.com", "username": "jjones",
        "address-line1": "7708 Covey Chase Dr", "address-city": "Charlotte",
        "address-state": "1", "address-zip": "28210"
    }
    return testCase
...
def basePwUpdate():
    testCase = {
        "old": "password", "new": "passwordnew", "confirmation": "passwordnew"
    }
    return testCase
...
def baseReview():
    testCase = {
        "home": "home", "category": "1", "id": "2", "name": "Evers Electric",
...
def newReviewDict():
    testCase = {
        "category": Category.query.get(1), "user": User.query.get(2),
        "provider": Provider.query.get(2), "rating": "3", "cost": "3",
        "description": "test", "service_date": "4/15/2019",
        "comments": "testcomments", "pictures": []
    }
    return testCase
...
def baseProviderNew():
    ...
    testCase = {
        "sector": "1", "category": ["1", "2"], "name": "Smith Electric",
        "telephone": "704-410-3873", "website": 'google.com',
        "email": "smith@smith.com", "address-line1": "7708 Covey Chase Dr",
...
def baseProviderSearch():
    testCase = {
        ...
        "gpsLong": "", "searchRange": 30, "sector": 1,  "category": 1,
        "name": None, "reviewed_filter": None, "friends_filter": None,
...
def baseGroupNew():
    ...
    testCase = {
        "name": "Porter's Pooches",
        "description": "Dogs that like to swim in the creek.", "admin_id": 2
    }
    return testCase
...
def baseMail():
    testCase = {
        "subject": "Test", "sender": TestConfig.ADMINS[0],
        "recipients": ["test@test.com"], "cc": ["test2@test.com"],
        "text_body": "hello world!", "html_body": "<p>hello world!<p>"
    }
    return testCase
...
def basePasswordReset():
    testCase = {
        "password_new": "password2", "password_confirmation": "password2"
    }
    return testCase
